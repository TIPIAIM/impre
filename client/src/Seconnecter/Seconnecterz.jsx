...
export default function Seconnecterz () {
  ...
  return (
    ...
    >
      ...
      >
        <h4>
          <Typewriter
            words={['Mes salutations', 'Vous êtes sur la bonne', 'Page de connexion', 'Saisissez les.','Bonnes informations']}
            loop={10}
            cursor
            cursorStyle=" -"
            typeSpeed={100}
       ...
       {/* <Link to='/senregistrer' style={{ textAlign: 'center', color: '#007bff', marginTop: '10px', textDecoration: 'underline' }}>
