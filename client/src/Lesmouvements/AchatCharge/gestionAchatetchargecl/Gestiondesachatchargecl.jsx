...
export default function Gestionachatchargecl() {
      ...
      <div className="absolute inset-0 bg-gray-400 bg-opacity-70 flex flex-col items-center justify-center">
        <div className="bg-gray-00 rounded-lg shadow-lg p-6 max-w-lg w-full mx-4">
          ...
          <nav className="text-blue-200" ref={scope}>
            ...
            >
              <li className="mt-2">
                <Link to="/achatchargecl" className="text-xl font-semibold text-green-950 hover:bg-gray-500 rounded-lg no-underline hover:text-pink-950">Enregistrer un achat ou charge</Link>
              </li>
              <li className="mt-2">
                <Link to="/achatchargelistecl" className="text-xl font-semibold text-green-950 hover:bg-gray-500 rounded-lg no-underline hover:text-pink-950">La liste des depenses</Link>
              </li>
