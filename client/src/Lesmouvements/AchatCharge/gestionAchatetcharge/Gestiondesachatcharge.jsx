...
export default function Gestionachatcharge() {
      ...
      <div className="absolute inset-0 bg-gray-400 bg-opacity-70 flex flex-col items-center justify-center">
        <div className="bg-gray-00 rounded-lg shadow-lg p-6 max-w-lg w-full mx-4">
          ...
          <nav className="text-blue-200" ref={scope}>
            ...
            >
              <li className="mt-2">
                <Link to="/achatcharge" className="hover:bg-gray-500 rounded-lg no-underline font-semibold text-green-950 hover:text-pink-950 transition-colors duration-300 text-xl ">Enregistrer un achat ou charge</Link>
              </li>
              <li className="mt-2">
                <Link to="/achatchargeliste" className="text-xl font-semibold text-green-950 hover:bg-gray-500 rounded-lg no-underline hover:text-pink-950 transition-colors duration-300">La liste des depenses</Link>
              </li>
        ...
        >
          <h1 className="text-4xl font-extrabold">Gestion de l'information sur les opérations d'achat ou depenses</h1>
        </motion.div>
      </div>
    </div>
  );
