...
export default function AchatchargeRecupliste() {
 ...
 const suprimerelement = (id) => {
    axios.delete(`${import.meta.env.VITE_APIserveur}/deleteachatoucharge/${id}`)
      .then(res => {
        console.log(res);
    ...
    >
      <div className="bg-gradient-to-t  from-gray-950 rounded-2xl flex justify-between items-center mb-4">
        <h2 className="m-2 text-2xl text-white font-bold flex items-center w-full">
          <Link to='/gestionachatoucharge' className="mx-2 bg-red-500 animate-pulse hover:bg-red-800 rounded-2xl">
      ...
      <div className="p-4 rounded shadow-md w-full">
        ...
        <Link to='/achatcharge' className="mx-2 animate-pulse bg-slate-300 hover:bg-black rounded-2xl">
            <MdAddCard size={35} />
          </Link>
          <input
            type="text"
          ...
          <table className="text-white table-auto w-full border-collapse">
            <thead className="bg-gradient-to-tr bg-blue-400 from-gray-950 rounded-2xl">
              <tr className="bg-gradient-to-tr  bg-blue-400 from-gray-950 rounded-2xl">
                ...
                <th className="px-1 py-1 text-center border-b border-yellow-500">Categories</th>
            ...
            <tbody>
              {sortedFlux.map((flu) => (
                ...
                >
                  ...
                  <td className="px-1 py-1 text-center border-l border-b border-r border-blue-500">{flu.categorie }</td>
