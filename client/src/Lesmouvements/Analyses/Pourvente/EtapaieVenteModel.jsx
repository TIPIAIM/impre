...
import SellRecupliste7pourmod from './SellRecupliste7pourmod';

export default function EtapaieVenteModelhh() {
      ...
      >
        <Modal.Header className='bg-gray-900' closeButton> {/* En-tête de la modale avec un bouton pour fermer */}
          <Modal.Title className='text-white font-serif font-bold'>
            Les Ventes recentes {/* Titre de la modale */}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body className=' bg-gray-950 '>
          <SellRecupliste7pourmod/>
        </Modal.Body>
      </Modal>
    </>
  );
