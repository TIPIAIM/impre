...
export default function SellRecuplifrs7mod() {
  ...
  const recentflu = flus.sort((a, b) => new Date(b.dateajout) - new Date(a.dateajout)).slice(0, 50);
  ...
  return (
    ...
    >
      <div className=" flex text-center ">
        ...
        <p className="text-sm mx-2 text-zinc-400 text-center "> Les fournisseurs recents: </p>
      </div>
        ...
        <table className=" text-sm text-white table-auto w-full border-collapse">
          <thead className='bg-gradient-to-tr bg-blue-400 from-gray-950 rounded-2xl'>
            <tr>
              ...
              <th className="px-2 py-2 text-center border-b border-green-600" style={{ width: '50px' }}>Nom Frs</th>
              <th className="px-2 py-2 text-center border-b border-green-600" style={{ width: '100px' }}>Prenoms</th>
              <th className="px-2 py-2 text-center border-b border-green-600" style={{ width: '120px' }}>Dates d'enregistr</th>
          ...
          <tbody>
            {recentflu.map((flu) => (
              ...
              >
                ...
                <td className="px-2 py-2 border-l border-b border-r border-blue-500">{flu.name}</td>
                <td className="px-2 py-2 border-l border-b border-r border-blue-500">{flu.nometprenom}</td>
                <td className="px-2 py-2 border-l border-b border-r border-blue-500">{formatDate(flu.dateajout)}</td>
