...
import SellRecuplifrs7mod from './SellRecuplifrs7mod';

export default function EtapaiefrsModelhh() {
      ...
      >
        <Modal.Header className='bg-gray-900' closeButton> {/* En-tête de la modale avec un bouton pour fermer */}
          <Modal.Title className='text-white font-serif font-bold'>
            L'enregistrements recents des fournisseurs {/* Titre de la modale */}
          </Modal.Title>
        </Modal.Header>
