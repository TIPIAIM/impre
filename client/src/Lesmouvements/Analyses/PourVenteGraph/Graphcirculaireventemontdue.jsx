...
export default function Graphcirculaireventemontdue() {
  ...
  filterflux.forEach(flux => {
    ...
    paymentMethods[method] = (paymentMethods[method] || 0) + flux.montant;
  });
  ...
  return (
    <div className="p-1 bg-gray-900 rounded-lg shadow-lg">
      <span className="text-zinc-500 text-sm mb-2">Moyen de payements  : Les montants dues des services vendus.   </span>
