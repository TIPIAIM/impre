...
export default function ListeFournisseurclient() {
    ...
    return (
        ...
        >
            ...
            <div className="bg-gradient-to-t  from-blue-500 rounded-2xl flex justify-between items-center mb-4">
                <h2 className="m-2 text-2xl text-white font-bold flex items-center w-full">
                    ...
                    <Link to='/gestionfournisseurclient' className="mx-2 bg-gray-800 hover:bg-gray-800 rounded-2xl">
                        <GiReturnArrow size={30} />
                    </Link>
                    Liste des fournisseurs
                </h2>
                {/* Image d'illustration */}
                <img src="/pictures/dickob.jpg" alt="dikob" className="m-1 h-20 w-20 rounded-2xl" />
            </div>
                ...
                <div className="overflow-x-auto">
                    <table className="text-white table-auto w-full border-collapse">
                        <thead className='bg-gradient-to-tr bg-blue-400 from-gray-950 rounded-2xl'>
                            ...
                            <th className="px-2 py-2 text-center border-b border-green-600" style={{ width: '150px' }}>Identifiants</th>
                          */} 
                            <th className="px-2 py-2 text-center border-b border-green-600" style={{ width: '100px' }}>L'entreprises</th>
                           ...
                           <th className="px-2 py-2 text-center border-b border-green-600" style={{ width: '100px' }}>Prenoms</th>
                                <th className="px-2 py-2 text-center border-b border-green-600" style={{ width: '120px' }}>Dates d'enreg</th>
                        ...
                        <tbody>
                            ...
                            {filtreclients.map((client) => (
                                <tr key={client._id} className={Changercouleurchamp(client.nature)}>
                                  ...
                                  <td className="px-2 py-2 border-l border-b border-r border-blue-500">{client.solde}</td>
                                  <td className="px-2 py-2 border-l border-b border-r border-blue-500">{client.name}</td>
                                    ...
                                    <td className="text-center px-2 py-2 border-b border-r border-blue-500">
                                        ...
                                        <Link to={`/Miseajourfrsclient/${client._id}`} className="text-center btn btn-warning">
                                            <ImPencil2 />
                                        </Link>
                                        {/* 
