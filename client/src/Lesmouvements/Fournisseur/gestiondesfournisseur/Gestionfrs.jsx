    ...
    <div className=' bg-gray-950 px-4' style={{ backgroundImage: `url('/pictures/clientparleho.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className=" bg-gradient-to-tr  py-3 px-5">
        <Link to="/admindasboardgenerale" className=''>
          <IoMdCloseCircleOutline size={30} className="bg-blue-200 hover:bg-red-700 rounded-full animate-pulse" />
        </Link>
      </div>
      <div className="flex justify-center items-center h-screen">
        <div className="md:flex justify-center items-center">
          <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap" className="m-4">
            <Link to="/fournisseur" className="no-underline text-xl font-serif font-bold">
              <motion.button
          ...
          <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap" className="m-4">
            <Link to="/listeFournisseur" className="no-underline text-xl font-serif font-bold">
              <motion.button
