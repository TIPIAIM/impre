...
export default function Factureinitialcl() {
  const { id } = useParams();
            ...
            <div key={index} className="border border-gray-300 p-1 rounded-md print:w-1/2 print:border-0 print:divide-y">
              ...
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="text-right font-serif">
                  <h3 className="  rounded-xl container text-center bg-pink-50 text-lg font-bold">Facture initial</h3>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm font-serif text-gray-700">Pour tout renseignement complémentaire, veuillez nous contacter.   Dikob imprimerie , Guinée - Labe - CU Pounthioun , 'RCCM/GN.2024.A.07504 NIF : 323996017'</p>
              </div>

              {/* Note Footer */}
              <div className="text-center font-serif text-xs text-gray-700">
