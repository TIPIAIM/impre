    ...
    >
      <div className="bg-gradient-to-t  from-gray-950 rounded-2xl flex justify-between items-center mb-4">
        <h2 className="m-2 text-2xl text-white font-bold flex items-center w-full">
          <Link to='/gestionstocketvntecl' className="mx-2 bg-gay-800 hover:bg-black rounded-2xl">
            <GiReturnArrow size={30} />
          </Link> Liste des ventes de services et produits
        </h2>
      ...
      <div className="p-4 rounded shadow-md w-full">
        <div className="p-4 flex flex-wrap justify-center items-center space-x-2 space-y-2 md:space-y-0">
          <Link to='/ventedesprod8cl' className="mx-2 animate-pulse bg-slate-300 hover:bg-black rounded-2xl">
            <MdAddCard size={35} />
          </Link>
          <input
            type="text"
...
*/}                  <td className="px-1 py-1 text-center border-b border-gray-600">{flu.clientId}</td>
                  ...
                  to={`/factureinitialcl/${flu._id}`} className=" px-2 py-1  m-1 text-center btn border-t-green-600">
                      <IoIosPrint />
                    </Link>
                    ...
                    to={`/miseRecupsalecl/${flu._id}`} className="text-cente m-1 text-white px-1 py-1 btn  border-t-green-600">
                      <BsPencilSquare />
                    </Link>
                    ...
                    to={`/facturepaiementdcl/${flu._id}`} className=" px-2 py-1  m-1 text-center btn text-yellow-600  border-t-pink-600">
                      <FaPrint />
                    </Link>
