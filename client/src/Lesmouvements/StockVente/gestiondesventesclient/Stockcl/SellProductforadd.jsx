...
const SellProductforadd = ({ onSaleCompleted }) => {
  ...
  return (
    <div className="px-1 rounded-lg bg-gradient-to-tr from-pink-400 to-gray-950 bg-gray-900 ">
      <Link to='/Ajoutstockcl' className="duration-600 mx-2 rounded-lg hover:bg-gray-600">
...
export default SellProductforadd;
