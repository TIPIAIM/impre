...
const AddProductcl = ({ onProductAdded }) => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gray-100">
      ...
      <div className="absolute top-4 right-4 flex space-x-2">
        <Link to='/listedesstockcl' className="duration-600 p-2 no-underline bg-green-800 text-white  mx-2 rounded-lg hover:bg-gray-600">
            <span className="material-icons">Stocks</span>
        </Link>
       
        <Link to='/gestionstocketvntecl' className="duration-600 p-1 no-underline  text-white  mx-1 rounded-lg hover:bg-pink-600">
          <FcLock size={40}  />
        </Link>
