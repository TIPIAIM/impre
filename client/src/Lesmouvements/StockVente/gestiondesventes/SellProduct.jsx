...
const SellProduct = ({ onSaleCompleted }) => {
 ...
 useEffect(() => {
  ...
  return (
    ...
    <Link to='/gestionstocketvnte' className="duration-600 mx-2 rounded-lg hover:bg-gray-600">
    ...
    <form onSubmit={handleSellProduct} className="max-w-lg mx-auto mt-1 font-serif rounded-md shadow-md">
      <h2 className="text-2xl font-bold mb-4 text-center">Vendre un Produit</h2>
        ...
        >
          ...
          {products.map((product) => (
            <option key={product._id} value={product._id}>
             {product.name} | {product.quantity}  en stock' | prix unitaire {product.price} GNF l'unité
            </option>
          ))}
        </select>
      </div>
<div className="mb-4">
      ...
      <div className="mb-4">
        <label className="block text-gray-700 mb-2">Saisir le nom du produit </label>
        <input
          type="texte"
      ...
      <div className="mb-4">
        <label className="block text-gray-700 mb-2">Prix Total du produit</label>
        <input
          type="number"
      ...
      <div className="mb-4">
        ...
        >
          <option value="">Sélectionnez l'état du paiement</option>
                  <option value="credit">Par crédit zero GNF</option>
                  ...
                  <option value="solde-facture">Paiement facture</option>
        </select>
      </div>
