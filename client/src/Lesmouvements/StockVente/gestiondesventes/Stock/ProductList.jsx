...
const ProductList = () => {
  ...
  const handleOpenSellForm = () => {
    navigate('/ventedesprod8'); // Remplacer par la route réelle du formulaire de vente de produit
  };

  const handleOpenAddStockForm = () => {
    navigate('/Ajoutstock'); // Remplacer par la route réelle du formulaire d'ajout de stock
  };
    ...
    <div className="min-h-screen bg-gray-900 py-10 flex flex-col items-center">
      <div className="max-w-6xl w-full p-6 bg-gray-800 shadow-lg rounded-lg">
        ...
        <div className="mb-6 flex items-center">
          <Link to="/Ajoutstock " className="flex text-green-50 animate-bounce  items-center hover:text-red-800 transition duration-300">
